...
public class ControllerAdministrarSalas implements Serializable {
    ...
    /*//EXPORTAR
     ...
     exporter.export(context, tabla, "PlataSalasLaboratorioPDF", false, false, "UTF-8", null, null);
     ...
     exporter.export(context, tabla, "PlataSalasLaboratorioXLS", false, false, "UTF-8", null, null);
     context.responseComplete();
     }
     */
