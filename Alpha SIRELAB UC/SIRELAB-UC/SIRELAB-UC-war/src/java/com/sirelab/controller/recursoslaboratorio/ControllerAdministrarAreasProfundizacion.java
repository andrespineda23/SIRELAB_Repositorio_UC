...
public class ControllerAdministrarAreasProfundizacion implements Serializable {
    ...
    /*
     ...
     exporter.export(context, tabla, "AdministrarAreasProfundizacionPDF", false, false, "UTF-8", null, null);
     ...
     exporter.export(context, tabla, "AdministrarAreasProfundizacionXLS", false, false, "UTF-8", null, null);
     context.responseComplete();
     }*/
    // GET - SET
