 ...
 * funcionamiento de la pagina administrardocentes.xhtml
 *
...
public class ControllerAdministrarDocentes implements Serializable {
    ...
    /*
     ...
     exporter.export(context, tabla, "AdministrarDocentesPDF", false, false, "UTF-8", null, null);
     ...
     exporter.export(context, tabla, "AdministrarDocentesXLS", false, false, "UTF-8", null, null);
     context.responseComplete();
     }
     */
    // GET - SET
