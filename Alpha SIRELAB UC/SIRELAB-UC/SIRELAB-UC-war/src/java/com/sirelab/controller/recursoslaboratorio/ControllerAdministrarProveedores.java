...
public class ControllerAdministrarProveedores implements Serializable {
    ...
    /*
     ...
     exporter.export(context, tabla, "RecursosProveedorPDF", false, false, "UTF-8", null, null);
     ...
     exporter.export(context, tabla, "RecursosProveedorXLS", false, false, "UTF-8", null, null);
     context.responseComplete();
     }*/
    // GET - SET
