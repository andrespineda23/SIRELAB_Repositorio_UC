...
public class ControllerAdministrarFacultades implements Serializable {
    ...
    /*
     ...
     exporter.export(context, tabla, "GestionarFacultadPDF", false, false, "UTF-8", null, null);
     ...
     exporter.export(context, tabla, "GestionarFacultadXLS", false, false, "UTF-8", null, null);
     context.responseComplete();
     }
     */
    // GET - SET
