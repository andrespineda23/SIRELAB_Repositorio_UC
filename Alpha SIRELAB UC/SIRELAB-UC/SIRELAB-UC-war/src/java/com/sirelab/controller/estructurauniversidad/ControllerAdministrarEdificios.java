...
public class ControllerAdministrarEdificios implements Serializable {
    ...
    /*
     ...
     exporter.export(context, tabla, "GestionarEdificiosPDF", false, false, "UTF-8", null, null);
     ...
     exporter.export(context, tabla, "GestionarEdificiosXLS", false, false, "UTF-8", null, null);
     context.responseComplete();
     }
     */
    // GET - SET
