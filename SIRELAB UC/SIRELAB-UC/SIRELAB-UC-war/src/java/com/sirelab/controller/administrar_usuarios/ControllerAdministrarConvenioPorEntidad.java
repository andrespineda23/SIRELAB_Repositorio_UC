...
public class ControllerAdministrarConvenioPorEntidad implements Serializable {
    ...
    public String limpiarProcesoBusqueda() {
        ...
        listaConvenios = null;
        listaEntidadesExternas = null;
        return "administrar_entidadesexternas";
    }
    ...
    public String verDetallesConvenioPorEntidad() {
        ...
        return "detalles_convenioporentidad";
    }
    
    public String verPersonaContacto() {
        limpiarProcesoBusqueda();
        return "administrar_personacontacto";
    }
    ...
    /*
     ...
     exporter.export(context, tabla, "Administrar_ConveniosPorEntidad_PDF", false, false, "UTF-8", null, null);
     ...
     exporter.export(context, tabla, "Administrar_ConveniosPorEntidad_XLS", false, false, "UTF-8", null, null);
     context.responseComplete();
     }
     */
    // GET - SET
